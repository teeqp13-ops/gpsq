...
gpsq_CFLAGS := -fobjc-arc -Wall -Wextra -Wno-deprecated-declarations -Wno-unused-function -Wno-unused-variable
gpsq_LDFLAGS := -Wl,-dead_strip

FakeGPSLocation_FILES := LocationSpoof.xm
FakeGPSLocation_FRAMEWORKS := Foundation CoreLocation
FakeGPSLocation_CFLAGS := -fobjc-arc -Wall -Wextra -Wno-deprecated-declarations -Wno-unused-function -Wno-unused-variable
