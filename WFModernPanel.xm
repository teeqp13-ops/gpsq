...
- (void)openPanel {
    ...
    self.gpsButton.frame = CGRectMake(16, 192, width, btnH);
    self.gpsButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightBold];
    ...
    favoritesButton.frame = CGRectMake(24 + width, 192, width, btnH);
    favoritesButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightBold];
    ...
    loadButton.frame = CGRectMake(16, 292, width, btnH);
    loadButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightBold];
    ...
    self.movementButton.frame = CGRectMake(24 + width, 292, width, btnH);
    self.movementButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightBold];
