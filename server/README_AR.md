# Wolf GPS V17 Server Panel

لوحة عربية RTL متكاملة لإدارة Wolf GPS V17 والأكواد والأجهزة والسجل والإعدادات.
...
```text
https://key.p3nd.fun/activation/api
```
...
- أكواد رقمية من 8 إلى 20 رقمًا متوافقة مع التطبيق.
- إنشاء كود واحد أو حتى 100 كود دفعة واحدة مع اختيار الطول.
- تحديد المدة وعدد الأجهزة والملاحظات.
- فصل جهاز، إعادة تعيين كود، إيقاف أو حذف.
- عرض معرف الجهاز وإدارة إعدادات البلوتوث في التطبيق.
- سجل عمليات وإعدادات الصيانة والتحديث الإجباري.
- تنزيل نسخة احتياطية من SQLite.
- حماية CSRF وجلسات آمنة ومنع الفهرسة.
- لا يتم إرسال مفتاح API الإداري إلى المتصفح.
